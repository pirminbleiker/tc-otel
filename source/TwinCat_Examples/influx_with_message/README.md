...
Die Beispiele können mit `git clone https://github.com/pirminbleiker/tc-otel.git` oder mit dem Download auf [log4TC](https://github.com/pirminbleiker/tc-otel) heruntergeladen werden. Dieses Beispiel inkl. SPS-Projekt befindet sich im Unterordner `influx_with_message`. 
