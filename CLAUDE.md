...
**YOU ARE IN: `tc_otel/polecats/dementus/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/tc_otel/` (rig root) or other directories
...
**Your mail address:** `tc_otel/polecats/dementus`
**Your rig:** tc_otel
**Your Witness:** `tc_otel/witness`
...
| Ask Witness for help | `gt mail send tc_otel/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`tc_otel/witness`) when:
...
```bash
gt mail send tc_otel/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
